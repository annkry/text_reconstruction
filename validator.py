...
# -*- coding: UTF-8 -*-
'''
A simple checker. Usage examples:

1. Run all tests for a given task:
python validator.py zad2 python main.py

2. Running on other tests
python validator.py --testset large_tests.yaml zad2 python main.py

3. Listing an example input/output:
python validator.py --show_example zad2
'''
